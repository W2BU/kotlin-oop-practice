...
fun main() {
    val notes: List<Note> = listOf(
        ...
        Note.UrlNote("Cool site", "habr.com"),
        Note.UrlNote("Complete 10 more", "leetcode.com"),
    ...
    myNotesService.add(Note.UrlNote("Check this out", "spotify.com"))
    ...
    println("\nFOUND BY TYPE \"UrlNote\":\n" + myNotesService.findByType("UrlNote"))
